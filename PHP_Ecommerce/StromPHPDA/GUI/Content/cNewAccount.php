...
<form  name="frmdangky" action="GUI/EXFuncion/xlCreateAcount.php" method="POST" onsubmit="return validate()">
    ...
    <table name="tttaikhoan" style="margin-left: 600px; font-size: 12px">
        <tr>
            ...
            <td> <input type="text" name ="ues" value="" maxlength="30" required/>  <?php
                if(isset($_GET["error"])) {
        ...
        <tr>
            ...
            <td> <input id="paw" type="password" name="paw" maxlength="30" value="" required/><br> </td>
        </tr>
        <tr>
    ...
    <table name="ttcanhan" style="margin-left: 600px; font-size: 13px">
        ...
        <tr>
            ...
            <td> <input type="text" name="ips" value="" required/><br> </td>
        </tr>
        <tr>
