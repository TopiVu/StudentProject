...
<form  name="frmdangky" action="ADcontent/Account/AC_xlUpdate.php" method="GET" ">
...
<table name="ttcanhan" style="margin-left: 600px; font-size: 13px">
    <tr>
        <td> <input type="hidden" name="ids" value="<?php echo "$taiKhoan->MaTaiKhoan"; ?>" required/><br> </td>
    </tr>
    <tr>
        <td>Tên tài khoản:<b style="color: #c80000">*</b></td>
        <td> <input type="text" name="us" value="<?php echo "$taiKhoan->TenDangNhap"; ?>" required/><br> </td>
    </tr>
    <tr>
        <td>Mật Khẩu:<b style="color: #c80000">*</b></td>
        <td> <input type="text" name="pass" value="<?php echo "$taiKhoan->MatKhau"; ?>" required/><br> </td>
    </tr>
    <tr>
